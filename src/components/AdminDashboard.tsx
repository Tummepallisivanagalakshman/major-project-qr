                  ...
                  <AnimatePresence>
                    {scanResult && (
                      <motion.div
                        ...
                        className={`absolute inset-0 flex flex-col items-center justify-start rounded-[2rem] z-20 overflow-y-auto p-6 ${scanResult.status === 'approve'
                            ? 'bg-emerald-600/97'
                            : 'bg-rose-600/97'
                          }`}
                      >
                        ...
                        {scanResult.studentProfile && (
                          <div className="w-full bg-white/15 backdrop-blur-sm rounded-2xl p-4 space-y-2 text-left border border-white/20">
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span className={`font-black text-xs px-2 py-0.5 rounded-full ${scanResult.studentProfile.status === 'Active'
