        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
          <div className="relative">
            ...
            <input 
              ...
              className="pl-10 pr-4 py-4 rounded-2xl border border-neutral-100 bg-white dark:bg-neutral-800 dark:border-neutral-700 shadow-sm outline-none font-bold text-neutral-600 dark:text-neutral-400 text-sm appearance-none"
            />
          </div>
          <div className="relative">
          ...
          <button className="flex items-center justify-center p-4 bg-white dark:bg-neutral-800 text-neutral-600 dark:text-neutral-400 rounded-2xl border border-neutral-100 dark:border-neutral-700 shadow-sm hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-all" title="Export Logs">
            <Download size={20} />
          </button>
        </div>
      </div>
                ...
                >
                  <td className="px-8 py-6">
                    <div className="flex flex-col min-w-0">
                      <span className="font-bold text-neutral-900 dark:text-white text-base truncate">{l.username}</span>
                      <span className="text-xs text-neutral-400 font-mono tracking-tighter truncate">{l.student_id}</span>
                    </div>
                  </td>
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-bold text-neutral-700 dark:text-neutral-300">{l.meal_type}</span>
                    </div>
                  </td>
                  <td className="px-8 py-6">
                  ...
                  <td className="px-8 py-6 text-right">
                    <div className="flex items-center justify-end gap-2 text-[10px] font-black text-neutral-400 uppercase tracking-widest">
