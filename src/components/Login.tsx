        ...
        <div className="glass-card p-10 rounded-[3rem] border border-white/20 dark:border-white/5 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 bg-neutral-900 dark:bg-white text-white dark:text-neutral-900 rounded-[2rem] font-black text-[10px] uppercase tracking-[0.2em] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-neutral-900/20 disabled:opacity-50 flex items-center justify-center gap-3 group overflow-hidden relative"
            >
          ...
          <div className="mt-10 pt-10 border-t border-neutral-100 dark:border-neutral-800 text-center">
            <p className="text-[10px] font-black text-neutral-400 uppercase tracking-widest">
              ...
              <Link to="/signup" className="text-neutral-900 dark:text-neutral-600 hover:underline inline-flex items-center gap-1">
                Initialize Account
                <Zap size={10} />
              </Link>
            </p>
